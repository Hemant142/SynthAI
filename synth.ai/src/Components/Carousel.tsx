...
//           <div
//             className="flex transition-transform duration-500 transform translate-x-0 space-x-4"
//             style={{
...
//           </div>
//           <button
//             className="absolute left-0 top-1/2 transform -translate-y-1/2 bg-white p-2 rounded-full shadow-lg cursor-pointer"
//             onClick={handlePrev}
//           >
//             &#9664;
//           </button>
//           <button
//             className="absolute right-0 top-1/2 transform -translate-y-1/2 bg-white p-2 rounded-full shadow-lg cursor-pointer"
//             onClick={handleNext}
//           >
//             &#9654;
//           </button>
